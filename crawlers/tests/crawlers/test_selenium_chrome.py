...
OFFSET = 999
REMOTE_PORT = 2 * OFFSET + 4444


@pytest.mark.parametrize("use_adblocking", [False, True])
def test_page_load_in_chrome_ok_adblocking(
    use_adblocking: bool,
) -> None:
    PAGE = "https://www.google.com/"
    traces = load_page_in_chrome(
        page_name=PAGE,
...
@pytest.mark.parametrize("use_adblocking", [False, True])
def test_page_load_in_chrome_fail_adblocking(
    use_adblocking: bool,
) -> None:
...
def test_page_load_in_chrome_ok_tracking(
...
@pytest.mark.parametrize("use_tracking_blocking", [False, True])
def test_page_load_in_chrome_fail_tracking(
    use_tracking_blocking: bool,
) -> None:
    PAGE = "https://this.domain.does.not.exist/"
    traces = load_page_in_chrome(
...
def test_page_load_in_chrome_ok_caching(
...
@pytest.mark.parametrize("use_http_caching", [False, True])
def test_page_load_in_chrome_fail_caching(
    use_http_caching: bool,
) -> None:
    PAGE = "https://this.domain.does.not.exist/"
    traces = load_page_in_chrome(
...
def test_page_load_in_chrome_ok_cookies(
...
@pytest.mark.parametrize("use_user_cookies", [False, True])
def test_page_load_in_chrome_fail_cookies(
    use_user_cookies: bool,
) -> None:
...
def test_page_load_in_chrome_ok_images(
    use_images: bool,
) -> None:
    PAGE = "https://www.google.com/"
    traces = load_page_in_chrome(
...
@pytest.mark.parametrize("use_images", [True, False])
def test_page_load_in_chrome_fail_images(
    use_images: bool,
) -> None:
    PAGE = "https://this.domain.does.not.exist/"
    traces = load_page_in_chrome(
...
def test_page_load_in_chrome_ok_dns_cache(
    use_dns_cache: bool,
) -> None:
    PAGE = "https://www.google.com/"
    traces = load_page_in_chrome(
...
@pytest.mark.parametrize("use_dns_cache", [True, False])
def test_page_load_in_chrome_fail_dns_cache(
    use_dns_cache: bool,
) -> None:
    PAGE = "https://this.domain.does.not.exist/"
    traces = load_page_in_chrome(
...
def test_page_load_in_chrome_user_agent(
    user_agent: str,
) -> None:
    PAGE = "https://www.google.com/"
    traces = load_page_in_chrome(
